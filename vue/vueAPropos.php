...
<main class="apropos-main">
    ...
    <section class="plot-twist">
        <h2>Plot-twist</h2>
        <p>
            Tu peux toi-même devenir organisateur de groupes ;<br><br>
            Réunis tes potes, tes camarades ou crée carrément un groupe public ouvert à n’importe<br>
            ...
            <div class="nous-contacter">
                <div class="formulaire">
                    <form action="#">
                        ...
                        <div>
                            ...
                            <input type="telephone" id="tel" placeholder="(+41) 76 000 00 00" name="tel">
                        </div>
                ...
                <div class="liens-utiles">
                    <div class="telephone">
                        ...
                        <a href="tel:+410221234567">022 123 45 67</a>
                    </div>
                    <div class="mail">
